...
The range of the `year` is between 1 and 2012.
...
After processing, there are 547 observations and 14 variables in the
dataset.
...
After processing, there are 94 observations and 13 variables in the
dataset.
...
After processing, there are 25 observations and 11 variables in the
dataset.
...
After row binding process, there are 666 observations and 16 variables
in the dataset.
...
```
    ...
    ## [1] "Participant only in baseline:"
...
After combining datasets with `id`, the result are of 475 observations
and 11 variables.
